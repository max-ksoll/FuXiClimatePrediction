...
def download_era5_surface_data(cds_client: cdsapi.api.Client, directory: os.PathLike | str,
    ...
    cds_client.retrieve("reanalysis-era5-complete", {
        "class": "ea",
        "date": "19400101/19400201/19400301/19400401",
        "expver": "1",
        "levtype": "sfc",
        "param": "34.128/40.128/139.128/165.128/166.128/167.128/228.128/147.128",
        "stream": "moda",
        "type": "an",
        "format": "netcdf",
        "grid": [1.5, 1.5]
...
if __name__ == '__main__':
    ...
    download_era5_surface_data(cds_client, "/Users/ksoll/git/FuXiClimatePrediction/data/sy_1958__ey_1958", 0, 0, )
