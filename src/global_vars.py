...
OPTIMIZER_REQUIRED_KEYS = ['optimizer_config_lr', 'optimizer_config_betas', 'optimizer_config_weight_decay', 'optimizer_config_T_0', 'optimizer_config_T_mult', 'optimizer_config_eta_min']
LAT_DIM = 121
LONG_DIM = 240
...
ORAS5_VARIABLES = [ "ocean_heat_content_for_the_total_water_column",
